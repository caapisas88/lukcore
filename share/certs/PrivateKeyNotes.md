...
unlocked to sign the Luk-Qt.app bundle.
...
allowing somebody to distribute a Luk-Qt.app or luk-qt-setup.exe with a valid
...
that the luk-qt.exe file inside the installer had not been tampered with.
