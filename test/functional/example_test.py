...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LukTestFramework
    pass

class ExampleTest(LukTestFramework):
    # Each functional test is a subclass of the LukTestFramework class.
    ...
    def custom_method(self):
        ...
        LukTestFramework class so other tests can use it."""
