...
# TestNode: A peer we use to send messages to lukd, and store responses.
...
class CompactBlocksTest(LukTestFramework):
    ...
    # This test actually causes lukd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that lukd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for lukd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # lukd will not send blocktxn responses for blocks whose height is
