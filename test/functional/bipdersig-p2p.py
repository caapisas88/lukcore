...
class BIP66Test(LukTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # lukd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and lukd produces more specific reject
            # reasons.
