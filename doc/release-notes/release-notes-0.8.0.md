Luk-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/luk/files/Luk/luk-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Luk
...
New/changed settings (command-line or luk.conf file)
--------------------------------------------------------
