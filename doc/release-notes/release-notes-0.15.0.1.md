Luk Core version *0.15.0.1* is now available from:

  <https://luk.org/bin/luk-core-0.15.0.1/>

and

  <https://lukcore.org/bin/luk-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/Luk-Qt` (on Mac)
or `lukd`/`luk-qt` (on Linux).
