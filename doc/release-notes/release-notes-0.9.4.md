Luk Core version 0.9.4 is now available from:

  https://luk.org/bin/0.9.4/
...
this update is incompatible with the Luk system and could lead to consensus
forks.

Luk Core released binaries from https://luk.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~luk/+archive/ubuntu/luk
- A third-party or self-compiled Luk Core

upgrade to Luk Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
