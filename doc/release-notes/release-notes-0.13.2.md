Luk Core version 0.13.2 is now available from:

  <https://luk.org/bin/luk-core-0.13.2/>
...
- #8908 `4a974b2` Update luk-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow luk-tx to create v2 transactions (btcdrak)
