Download URL: https://sourceforge.net/projects/luk/files/Luk/luk-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LUK fee schedule (users still pay 0.01 LUK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #luk00 - #luk99
