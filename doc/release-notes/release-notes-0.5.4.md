Luk version 0.5.4 is now available for download at:
http://sourceforge.net/projects/luk/files/Luk/luk-0.5.4/
...
http://gitorious.org/luk/lukd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Luk-Qt notifications under Growl 1.3.
Increase required age of Luk-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLuk properly when installing Luk-Qt over it. (Windows)
