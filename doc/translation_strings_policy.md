...
This document provides guidelines for internationalization of the Luk Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `luk_en.ts` remains unchanged.
