...
#ifndef LUK_TEST_SCRIPTNUM10_H
#define LUK_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from Luk Core 0.10.0, for cross-comparison.
 */
public:
