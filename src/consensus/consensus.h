...
#ifndef LUK_CONSENSUS_CONSENSUS_H
#define LUK_CONSENSUS_CONSENSUS_H
...
// version. The former uses Luk parameters, but if this fork is a fork
...
#endif // LUK_CONSENSUS_CONSENSUS_H
