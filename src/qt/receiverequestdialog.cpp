...
#include "config/luk-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLukURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + LukUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLukURI(info));
}
