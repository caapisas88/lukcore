...
#ifndef LUK_QT_LUKUNITS_H
#define LUK_QT_LUKUNITS_H
...
*/
class LukUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LukUnits(QObject* parent);

    /** Luk units.
      @note Source: https://en.luk.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        LUK,
        mLUK,
...
typedef LukUnits::Unit LukUnit;

#endif // LUK_QT_LUKUNITS_H
